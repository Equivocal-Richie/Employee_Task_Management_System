							...
							<div class="col-md-12">
								<form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
									<div class="form-group">
										...
										<div class="">
											<input type="text" placeholder="Task Title" id="task_title" name="task_title" list="expense" class="form-control rounded-0" value="<?php echo $row['task_title']; ?>" <?php if ($user_role != 1) { ?> readonly <?php } ?> val required>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label text-p-reset">Task Description</label>
										<div class="">
											<textarea name="task_description" id="task_description" placeholder="Text Description" class="form-control rounded-0" rows="5" cols="5"><?php echo $row['task_description']; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label text-p-reset">Start Time</label>
										<div class="">
											<input type="text" name="t_start_time" id="t_start_time" class="form-control rounded-0" value="<?php echo $row['task_start_time']; ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label text-p-reset">End Time</label>
										<div class="">
											<input type="text" name="t_end_time" id="t_end_time" class="form-control rounded-0" value="<?php echo $row['task_end_time']; ?>">
										</div>
									</div>
									...
									<div class="form-group">
										<label class="control-label text-p-reset">Task Grading</label>
										<div class="">
											<select class="form-control rounded-0" name="task_grade" id="task_grade">
												<option value="0" <?php if ($row['task_grade'] == 0) { ?>selected <?php } ?>>Good</option>
												<option value="1" <?php if ($row['task_grade'] == 1) { ?>selected <?php } ?>>Very Good</option>
												<option value="2" <?php if ($row['task_grade'] == 2) { ?>selected <?php } ?>>Exceptional</option>
												<option value="3" <?php if ($row['task_grade'] == 3) { ?>selected <?php } ?>>Bad</option>
											</select>
										</div>
									</div>
									<div class="form-group">
